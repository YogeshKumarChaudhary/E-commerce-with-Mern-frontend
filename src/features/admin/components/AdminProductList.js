          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <div>
                  <Link to="/admin/product-form" className="rounded-md mx-9 my-3 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                    Add New Product
                  </Link>
                </div>
...
function DesktopFilter({ handlFilter, filters }) {
  return (
                  ...
                  {section.options.map((option, optionIdx) => (
                    <div key={option.value} className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        defaultChecked={option.checked}
                        onChange={(e) => handlFilter(e, section, option)}
                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label
...
function Pagination({ handlPage, page, totalItems }) {
  const totalPages = Math.ceil(totalItems / ITEM_PER_PAGE);
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <div
          onClick={(e) => handlPage(page > 1 ? page - 1 : page)}
        ...
        <div
          onClick={(e) => handlPage(page < totalPages ? page + 1 : page)}
